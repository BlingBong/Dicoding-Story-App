package com.example.dicodingstoryapp.ui.camera
...
import com.example.dicodingstoryapp.databinding.ActivityCameraBinding
import com.example.dicodingstoryapp.ui.addstory.AddStoryActivity
import com.example.dicodingstoryapp.utils.createFile
...
class CameraActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cameraBinding.civCapture.setOnClickListener { takePhoto() }
        cameraBinding.ivSwitch.setOnClickListener {
            cameraSelector =
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            try {
                ...
                Toast.makeText(
                    this@CameraActivity,
                    getString(R.string.start_cam_failed),
                    Toast.LENGTH_SHORT
                ).show()
            }
        }, ContextCompat.getMainExecutor(this))
